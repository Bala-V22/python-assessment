...
def incoming_data(request):
    ...
    for destination in account.destinations.all():
        ...
        # Here i am used try and except because the I'm given url is fake so i can't send the data in that url so i am repond the data to postman
        try:
            if method == 'get':
            ...
            # I'm comment this because i am not using try except this will be usefull
